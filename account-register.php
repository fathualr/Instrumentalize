...
<head>
    ...
    <title>INSTRUMENTALIZE - Register</title>
    <!--Logo Website-->
    ...
    <nav class="navbar navbar-expand-lg fixed-top" id="navbar">
        <div class="container-fluid" id="container-navbar-item">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="container-fluid px-0 d-flex mb-3 mb-lg-0">
                    ...
                    <ul class="d-none d-lg-flex navbar-nav my-auto me-lg-5" id="user-navigation">
                        <li class="nav-item">
                            <?php 
                            if(isset($_SESSION["user_email"])){
        ...
        <div class="container" id="container-account">
            <div class="col">
                <div class="text-center mt-3 my-lg-3">
                    <span class="font-40"><b>Daftar Akun</b></span>
                </div>
            </div>
            <div class="d-flex flex-column mt-4 mt-lg-5">
                <div class="container mt-auto" id="container-account-form">
                    <form action="" method="post" id="register-user-form">
                        ...
                        <div class="form-floating mb-2 mx-3 mx-lg-0">
                            <input type="text" class="form-control focus-ring focus-ring-secondary account-input" name="user_name" id="user_name" placeholder="Nama Depan" required>
                        ...
                        <div class="form-floating mb-2 mx-3 mx-lg-0">
                            <input type="date" class="form-control focus-ring focus-ring-secondary account-input" name="user_birthday" id="user_birthday" placeholder="Tanggal Lahir" required>
                            <label for="user_birthday">Tanggal Lahir</label>
                        </div>
                        <div class="form-floating mb-2 mx-3 mx-lg-0">
                            <select class="form-select form-control focus-ring focus-ring-secondary account-input" name="user_gender" id="user_gender" placeholder="Jenis Kelamin" required>
                        ...
                        <div class="form-floating mb-2 mx-3 mx-lg-0">
                            <input type="number" class="form-control focus-ring focus-ring-secondary account-input" name="user_phone" id="user_phone" placeholder="Nomor Telepon" required>
                        ...
                        <div class="form-floating mb-2 mx-3 mx-lg-0">
                            <input type="password" class="form-control focus-ring focus-ring-secondary account-input" name="user_password2" id="user_pass2" placeholder="Konfirmasi Password" required>
                            <label for="user_password2">Konfirmasi Password</label>
                            <i class="fa-solid fa-eye" id="show_user_pass2" onclick="show_password('user_pass2')"></i>
                        </div>
                        <div class="d-flex justify-content-center" >
                            <button class="btn btn-light account-submit p-0" type="submit" name="register_user">Buat akun</button>
                        </div>
                    </form>
                </div>
                <div class="d-flex flex-column align-items-center m-3" id="user-footer">
                    ...
                    <div class="text-center text-dark text-opacity-75">
                        ...
                        <a class="" href="account-login.php">Masuk</a>
                    </div>
                </div>
            </div>
        </div>
